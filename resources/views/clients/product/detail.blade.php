                    ...
                    <div>
                        <a data-fslightbox="gallery" href="{{ asset('storage/uploads/products/' . $product->image) }}">
                            <img alt="{{ $product->name }}"
                                class="relative mb-8 w-full rounded-lg object-cover md:h-80 md:w-80" loading="lazy"
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex flex-wrap items-center gap-4 md:gap-8">
                                @foreach ($attribute->values as $value)
                                    <div class="min-w-32">
                                        <input checked class="peer hidden" id="option_{{ $value->id }}"
                                            name="attribute_{{ $attribute->id }}" required type="radio"
                                            value="{{ $value->value }}" />
                ...
                <div class="card p-4 md:p-8 col-span-5">
                    ...
                    <div class="mb-4 px-8">
                        <p class="mb-4 text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates ducimus
                            ...
                            ullam tempora fuga pariatur tempore odit sunt quas excepturi aliquid eos, reprehenderit, velit
                            commodi culpa harum nihil minus? Quibusdam enim at error saepe.</p>
        ...
        <div class="sticky bottom-16 w-full border-t bg-white p-4 transition md:px-24 lg:bottom-0 lg:px-32">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-end gap-2">
                    <form action="{{ route('client.product.post-favorite', $product->slug) }}" id="favorite-form"
                        method="POST">
                        @csrf
                        <button class="button-gray {{ $favorites->contains($product->id) ? 'button-red' : '' }}"
                            type="submit">
